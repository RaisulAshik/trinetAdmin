...
import { sAdminBlogTextApi } from "../../api";
...
class BlogText extends Component {
  ...
  componentDidMount() {
    ...
    sAdminBlogTextApi
      .sAdminGetBlogTextDetails(formattedToken)
      .then((response) => {
        this.setState({
  ...
  handleSubmit(e) {
    ...
    sAdminBlogTextApi
      .sAdminUpdateBlogTextDetails(data, formattedToken)
      .then((response) => {
        this.setState({
          submitting: false,
          errorStatus: null,
...
export default connect(mapStateToProps)(BlogText);
