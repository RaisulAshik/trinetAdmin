...
const fields = ["name", "filter", "action"];
...
class PortfolioList extends Component {
  ...
  componentDidMount() {
    ...
    sAdminPortfolioApi
      .sAdminGetPortfolioList(formattedToken)
      .then((response) => {
        this.setState({
          data: response.data,
  ...
  handleDelete() {
    ...
    sAdminPortfolioApi
      .sAdminDeletePortfolio(_id, formattedToken)
      .then((response) => {
        this.setState({
          deleting: false,
    ...
    return (
      <>
        <CRow>
          <CCol>
            <CCard>
              <CCardHeader>Portfolio List</CCardHeader>
              <CCardBody>
                <CDataTable
                  items={data}
                  fields={fields}
                  ...
                  scopedSlots={{
                    action: (item) => (
                      <td>
                        <CRow>
                          <Link to={ "/portfolio/portfolio-edit/" + item._id}>
                          ...
                          {/* <CLink
                            ...
                            onClick={() =>
                              history.push(
                                "/#/portfolio/portfolio-edit/" + item._id
                              )
                            }
                          >
                            <CIcon name="cil-pencil" title="Edit" />
