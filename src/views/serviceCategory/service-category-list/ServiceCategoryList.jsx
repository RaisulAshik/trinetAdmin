...
class ServiceCategoryList extends Component {
  ...
  handleDelete() {
    ...
    sAdminServiceCategoryApi
      .sAdminDeleteServiceCategory(_id, formattedToken)
      .then((response) => {
        this.setState({
          deleting: false,
    ...
    return (
      <>
        <CRow>
          <CCol>
            <CCard>
              <CCardHeader>Service Category List</CCardHeader>
              <CCardBody>
                <CDataTable
                  items={data}
                  fields={fields}
                  ...
                  scopedSlots={{
                    action: (item) => (
                      <td>
                        <CRow>
                          <Link to={"/service/service-category-edit/" + item._id}>
                          ...
                          {/* <CLink
                            ...
                            onClick={() =>
                              history.push(
                                "/#/service/service-category-edit/" + item._id
                              )
                            }
                          >
                            <CIcon name="cil-pencil" title="Edit" />
