...
import { sAdminTestimonialTextApi } from "../../api";
...
class TestimonialText extends Component {
  ...
  componentDidMount() {
    ...
    sAdminTestimonialTextApi
      .sAdminGetTestimonialTextDetails(formattedToken)
      .then((response) => {
        this.setState({
  ...
  handleSubmit(e) {
    ...
    sAdminTestimonialTextApi
      .sAdminUpdateTestimonialTextDetails(data, formattedToken)
      .then((response) => {
        this.setState({
          submitting: false,
          errorStatus: null,
    ...
    return (
      <>
        <CRow>
          <CCol xs="12">
            <CCard>
              <CCardHeader>Details of "Testimonial Text"</CCardHeader>
              <CCardBody>
                {submitted && errorStatus === 400 && (
                  <span className="validation-error mt-2">
                    Updating Testimonial Text Failed
                  </span>
                )}
...
export default connect(mapStateToProps)(TestimonialText);
