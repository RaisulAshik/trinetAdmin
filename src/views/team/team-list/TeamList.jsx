...
const fields = ["name", "designation", "action"];
...
class TeamList extends Component {
  ...
  componentDidMount() {
    ...
    sAdminTeamApi.sAdminGetTeamList(formattedToken).then((response) => {
      this.setState({
        data: response.data,
  ...
  handleDelete() {
    ...
    sAdminTeamApi
      .sAdminDeleteTeam(_id, formattedToken)
      .then((response) => {
        this.setState({
          deleting: false,
                ...
                <CDataTable
                  ...
                  scopedSlots={{
                    action: (item) => (
                      <td>
                        <CRow>
                          <Link to={"/team/team-edit/" + item._id}>
                            <CIcon name="cil-pencil" title="Edit" />
                          </Link>
                          {/* <CLink
                            className="card-header-action"
                            onClick={() =>
                              history.push("/#/team/team-edit/" + item._id)
                            }
                          >
                            <CIcon name="cil-pencil" title="Edit" />
                          </CLink> */}
