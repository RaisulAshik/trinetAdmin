...
const fields = ["authorName", "title", "action"];
...
class BlogList extends Component {
  ...
  componentDidMount() {
    ...
    sAdminBlogApi.sAdminGetBlogList(formattedToken).then((response) => {
      this.setState({
        data: response.data,
  ...
  handleDelete() {
    ...
    sAdminBlogApi
      .sAdminDeleteBlog(_id, formattedToken)
      .then((response) => {
        this.setState({
          deleting: false,
                ...
                <CDataTable
                  ...
                  scopedSlots={{
                    action: (item) => (
                      <td>
                        <CRow>
                          <Link to={"/blog/blog-edit/" + item._id}>
                            <CIcon name="cil-pencil" title="Edit" />
                          </Link>
                          {/* <CLink
                            className="card-header-action"
                            onClick={() =>
                              history.push("/blog/blog-edit/" + item._id)
                            }
                          > */}
                          {/* </CLink> */}
