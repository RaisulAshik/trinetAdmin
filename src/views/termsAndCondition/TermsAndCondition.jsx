...
import { sAdminTermsAndConditionApi } from "../../api";
...
class TermsAndCondition extends Component {
  ...
  componentDidMount() {
    ...
    sAdminTermsAndConditionApi
      .sAdminGetTermsAndConditionDetails(formattedToken)
      .then((response) => {
        this.setState({
  ...
  handleSubmit(e) {
    ...
    sAdminTermsAndConditionApi
      .sAdminUpdateTermsAndConditionDetails(data, formattedToken)
      .then((response) => {
        this.setState({
          submitting: false,
          errorStatus: null,
    ...
    return (
      <>
        <CRow>
          <CCol xs="12">
            <CCard>
              <CCardHeader>Terms and Conditions</CCardHeader>
              <CCardBody>
                {submitted && errorStatus === 400 && (
                  <span className="validation-error mt-2">
                    Updating Terms and Conditions Failed
                  </span>
                )}
