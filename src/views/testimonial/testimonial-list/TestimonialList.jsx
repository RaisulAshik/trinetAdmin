...
const fields = ["name", "review", "action"];
...
class TestimonialList extends Component {
  ...
  componentDidMount() {
    ...
    sAdminTestimonialApi
      .sAdminGetTestimonialList(formattedToken)
      .then((response) => {
        this.setState({
          data: response.data,
  ...
  handleDelete() {
    ...
    sAdminTestimonialApi
      .sAdminDeleteTestimonial(_id, formattedToken)
      .then((response) => {
        this.setState({
          deleting: false,
                ...
                <CDataTable
                  ...
                  scopedSlots={{
                    action: (item) => (
                      <td>
                        <CRow>
                          <Link to={"/testimonial/testimonial-edit/" + item._id}>
                          ...
                          {/* <CLink
                            ...
                            onClick={() =>
                              history.push(
                                "/#/testimonial/testimonial-edit/" + item._id
                              )
                            }
                          >
                            <CIcon name="cil-pencil" title="Edit" />
